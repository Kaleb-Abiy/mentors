...
DATABASES = {
    'default': dj_database_url.config(
        default=f'postgresql://postgres:{db_pass}@viaduct.proxy.rlwy.net:20924/railway',
        conn_max_age=600,
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'A mentorship API that connects users with mentors',
    'VERSION': '1.0.0',
